...
function preload(){
    thunderimg1 = loadImage("images/lightning1.png");
    thunderimg2 = loadImage("images/lightning2.png");
    thunderimg3 = loadImage("images/lightning3.png");
    thunderimg4 = loadImage("images/lightning4.png");
}
...
function draw(){
    ...
    if(thunderZero + 10 ===frameCount && thunder)
    { 
        thunder.destroy(); 
    }
